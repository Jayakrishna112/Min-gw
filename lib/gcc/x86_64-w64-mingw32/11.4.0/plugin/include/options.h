...
enum opt_code
{
  ...
  OPT_mdaz_ftz = 1743,                       /* -mdaz-ftz */
  OPT_mdispatch_scheduler = 1744,            /* -mdispatch-scheduler */
  OPT_mdll = 1745,                           /* -mdll */
  OPT_mdump_tune_features = 1746,            /* -mdump-tune-features */
  OPT_menqcmd = 1747,                        /* -menqcmd */
  OPT_mf16c = 1748,                          /* -mf16c */
  OPT_mfancy_math_387 = 1749,                /* -mfancy-math-387 */
  OPT_mfentry = 1750,                        /* -mfentry */
  OPT_mfentry_name_ = 1751,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1752,               /* -mfentry-section= */
  OPT_mfma = 1753,                           /* -mfma */
  OPT_mfma4 = 1754,                          /* -mfma4 */
  OPT_mforce_drap = 1755,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1756,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1757,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1758,                       /* -mfpmath= */
  OPT_mfsgsbase = 1759,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1760,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1761, */              /* -mfused-madd */
  OPT_mfxsr = 1762,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1763,             /* -mgeneral-regs-only */
  OPT_mgfni = 1764,                          /* -mgfni */
  OPT_mhard_float = 1765,                    /* -mhard-float */
  OPT_mharden_sls_ = 1766,                   /* -mharden-sls= */
  OPT_mhle = 1767,                           /* -mhle */
  OPT_mhreset = 1768,                        /* -mhreset */
  OPT_miamcu = 1769,                         /* -miamcu */
  OPT_mieee_fp = 1770,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1771,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 1772,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 1773,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1774,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1775,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1776,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1777,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1778, */            /* -mintel-syntax */
  OPT_mkl = 1779,                            /* -mkl */
  OPT_mlarge_data_threshold_ = 1780,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1781,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1782,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1783,                /* -mlong-double-80 */
  OPT_mlwp = 1784,                           /* -mlwp */
  OPT_mlzcnt = 1785,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1786,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1787,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1788,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1789,                  /* -mmitigate-rop */
  OPT_mmmx = 1790,                           /* -mmmx */
  OPT_mmovbe = 1791,                         /* -mmovbe */
  OPT_mmovdir64b = 1792,                     /* -mmovdir64b */
  OPT_mmovdiri = 1793,                       /* -mmovdiri */
  OPT_mmpx = 1794,                           /* -mmpx */
  OPT_mms_bitfields = 1795,                  /* -mms-bitfields */
  OPT_mmwait = 1796,                         /* -mmwait */
  OPT_mmwaitx = 1797,                        /* -mmwaitx */
  OPT_mneeded = 1798,                        /* -mneeded */
  OPT_mno_align_stringops = 1799,            /* -mno-align-stringops */
  OPT_mno_default = 1800,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1801,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1802,                  /* -mno-push-args */
  OPT_mno_red_zone = 1803,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1804,                       /* -mno-sse4 */
  OPT_mnop_fun_dllimport = 1805,             /* -mnop-fun-dllimport */
  OPT_mnop_mcount = 1806,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1807,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1808,                          /* -mpc32 */
  OPT_mpc64 = 1809,                          /* -mpc64 */
  OPT_mpc80 = 1810,                          /* -mpc80 */
  OPT_mpclmul = 1811,                        /* -mpclmul */
  OPT_mpcommit = 1812,                       /* -mpcommit */
  OPT_mpconfig = 1813,                       /* -mpconfig */
  OPT_mpe_aligned_commons = 1814,            /* -mpe-aligned-commons */
  OPT_mpku = 1815,                           /* -mpku */
  OPT_mpopcnt = 1816,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1817, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1818,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1819,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1820,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1821,                        /* -mprfchw */
  OPT_mptwrite = 1822,                       /* -mptwrite */
  OPT_mpush_args = 1823,                     /* -mpush-args */
  OPT_mrdpid = 1824,                         /* -mrdpid */
  OPT_mrdrnd = 1825,                         /* -mrdrnd */
  OPT_mrdseed = 1826,                        /* -mrdseed */
  OPT_mrecip = 1827,                         /* -mrecip */
  OPT_mrecip_ = 1828,                        /* -mrecip= */
  OPT_mrecord_mcount = 1829,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1830,                 /* -mrecord-return */
  OPT_mred_zone = 1831,                      /* -mred-zone */
  OPT_mregparm_ = 1832,                      /* -mregparm= */
  OPT_mrtd = 1833,                           /* -mrtd */
  OPT_mrtm = 1834,                           /* -mrtm */
  OPT_msahf = 1835,                          /* -msahf */
  OPT_mserialize = 1836,                     /* -mserialize */
  OPT_msgx = 1837,                           /* -msgx */
  OPT_msha = 1838,                           /* -msha */
  OPT_mshstk = 1839,                         /* -mshstk */
  OPT_mskip_rax_setup = 1840,                /* -mskip-rax-setup */
  OPT_msoft_float = 1841,                    /* -msoft-float */
  OPT_msse = 1842,                           /* -msse */
  OPT_msse2 = 1843,                          /* -msse2 */
  OPT_msse2avx = 1844,                       /* -msse2avx */
  OPT_msse3 = 1845,                          /* -msse3 */
  OPT_msse4 = 1846,                          /* -msse4 */
  OPT_msse4_1 = 1847,                        /* -msse4.1 */
  OPT_msse4_2 = 1848,                        /* -msse4.2 */
  OPT_msse4a = 1849,                         /* -msse4a */
  /* OPT_msse5 = 1850, */                    /* -msse5 */
  OPT_msseregparm = 1851,                    /* -msseregparm */
  OPT_mssse3 = 1852,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1853,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1854, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1855,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1856, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1857,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1858,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1859,            /* -mstringop-strategy= */
  OPT_mstv = 1860,                           /* -mstv */
  OPT_mtbm = 1861,                           /* -mtbm */
  OPT_mthreads = 1862,                       /* -mthreads */
  OPT_mtls_dialect_ = 1863,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1864,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 1865,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 1866,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1867,                         /* -mtune= */
  OPT_muintr = 1868,                         /* -muintr */
  OPT_municode = 1869,                       /* -municode */
  OPT_muse_libstdc_wrappers = 1870,          /* -muse-libstdc-wrappers */
  OPT_mvaes = 1871,                          /* -mvaes */
  OPT_mveclibabi_ = 1872,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1873,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1874,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1875,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1876,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1877,                      /* -mwbnoinvd */
  OPT_mwidekl = 1878,                        /* -mwidekl */
  OPT_mwin32 = 1879,                         /* -mwin32 */
  OPT_mwindows = 1880,                       /* -mwindows */
  OPT_mx32 = 1881,                           /* -mx32 */
  OPT_mxop = 1882,                           /* -mxop */
  OPT_mxsave = 1883,                         /* -mxsave */
  OPT_mxsavec = 1884,                        /* -mxsavec */
  OPT_mxsaveopt = 1885,                      /* -mxsaveopt */
  OPT_mxsaves = 1886,                        /* -mxsaves */
  OPT_n = 1887,                              /* -n */
  OPT_name_sort = 1888,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1889,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1890,              /* -no-integrated-cpp */
  OPT_no_pie = 1891,                         /* -no-pie */
  OPT_no_pthread = 1892,                     /* -no-pthread */
  OPT_nocpp = 1893,                          /* -nocpp */
  OPT_nodefaultlibs = 1894,                  /* -nodefaultlibs */
  OPT_nolibc = 1895,                         /* -nolibc */
  OPT_nophoboslib = 1896,                    /* -nophoboslib */
  OPT_nostartfiles = 1897,                   /* -nostartfiles */
  OPT_nostdinc = 1898,                       /* -nostdinc */
  OPT_nostdinc__ = 1899,                     /* -nostdinc++ */
  OPT_nostdlib = 1900,                       /* -nostdlib */
  OPT_o = 1901,                              /* -o */
  OPT_objects = 1902,                        /* -objects */
  OPT_p = 1903,                              /* -p */
  OPT_pass_exit_codes = 1904,                /* -pass-exit-codes */
  /* OPT_pedantic = 1905, */                 /* -pedantic */
  OPT_pedantic_errors = 1906,                /* -pedantic-errors */
  OPT_pg = 1907,                             /* -pg */
  OPT_pie = 1908,                            /* -pie */
  OPT_pipe = 1909,                           /* -pipe */
  OPT_posix = 1910,                          /* -posix */
  OPT_print_file_name_ = 1911,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1912,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1913,          /* -print-multi-directory */
  OPT_print_multi_lib = 1914,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1915,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1916,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1917,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1918,               /* -print-prog-name= */
  OPT_print_search_dirs = 1919,              /* -print-search-dirs */
  OPT_print_sysroot = 1920,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1921,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1922,                    /* -print-value */
  OPT_pthread = 1923,                        /* -pthread */
  OPT_quiet = 1924,                          /* -quiet */
  OPT_r = 1925,                              /* -r */
  OPT_remap = 1926,                          /* -remap */
  OPT_reverse_sort = 1927,                   /* -reverse-sort */
  OPT_s = 1928,                              /* -s */
  OPT_save_temps = 1929,                     /* -save-temps */
  OPT_save_temps_ = 1930,                    /* -save-temps= */
  OPT_shared = 1931,                         /* -shared */
  OPT_shared_libgcc = 1932,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1933,               /* -shared-libphobos */
  OPT_size_sort = 1934,                      /* -size-sort */
  /* OPT_specs = 1935, */                    /* -specs */
  OPT_specs_ = 1936,                         /* -specs= */
  OPT_static = 1937,                         /* -static */
  OPT_static_libasan = 1938,                 /* -static-libasan */
  OPT_static_libgcc = 1939,                  /* -static-libgcc */
  OPT_static_libgfortran = 1940,             /* -static-libgfortran */
  OPT_static_libgo = 1941,                   /* -static-libgo */
  OPT_static_libhwasan = 1942,               /* -static-libhwasan */
  OPT_static_liblsan = 1943,                 /* -static-liblsan */
  OPT_static_libmpx = 1944,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1945,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1946,               /* -static-libphobos */
  OPT_static_libstdc__ = 1947,               /* -static-libstdc++ */
  OPT_static_libtsan = 1948,                 /* -static-libtsan */
  OPT_static_libubsan = 1949,                /* -static-libubsan */
  OPT_static_pie = 1950,                     /* -static-pie */
  /* OPT_std_c__03 = 1951, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1952, */                /* -std=c++0x */
  OPT_std_c__11 = 1953,                      /* -std=c++11 */
  OPT_std_c__14 = 1954,                      /* -std=c++14 */
  OPT_std_c__17 = 1955,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1956, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1957, */                /* -std=c++1z */
  OPT_std_c__20 = 1958,                      /* -std=c++20 */
  OPT_std_c__23 = 1959,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1960, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1961, */                /* -std=c++2b */
  OPT_std_c__98 = 1962,                      /* -std=c++98 */
  OPT_std_c11 = 1963,                        /* -std=c11 */
  OPT_std_c17 = 1964,                        /* -std=c17 */
  /* OPT_std_c18 = 1965, */                  /* -std=c18 */
  /* OPT_std_c1x = 1966, */                  /* -std=c1x */
  OPT_std_c2x = 1967,                        /* -std=c2x */
  /* OPT_std_c89 = 1968, */                  /* -std=c89 */
  OPT_std_c90 = 1969,                        /* -std=c90 */
  OPT_std_c99 = 1970,                        /* -std=c99 */
  /* OPT_std_c9x = 1971, */                  /* -std=c9x */
  OPT_std_f2003 = 1972,                      /* -std=f2003 */
  OPT_std_f2008 = 1973,                      /* -std=f2008 */
  OPT_std_f2008ts = 1974,                    /* -std=f2008ts */
  OPT_std_f2018 = 1975,                      /* -std=f2018 */
  OPT_std_f95 = 1976,                        /* -std=f95 */
  OPT_std_gnu = 1977,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1978, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1979, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1980,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1981,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1982,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1983, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1984, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1985,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1986,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1987, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1988, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1989,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1990,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1991,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1992, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1993, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1994,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1995, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1996,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1997,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1998, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1999, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2000,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2001, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2002, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2003, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2004, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2005, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 2006,                     /* -std=legacy */
  OPT_stdlib_ = 2007,                        /* -stdlib= */
  OPT_symbol_ = 2008,                        /* -symbol= */
  OPT_symbolic = 2009,                       /* -symbolic */
  OPT_t = 2010,                              /* -t */
  OPT_time = 2011,                           /* -time */
  OPT_time_ = 2012,                          /* -time= */
  OPT_traditional = 2013,                    /* -traditional */
  OPT_traditional_cpp = 2014,                /* -traditional-cpp */
  OPT_tree_stats = 2015,                     /* -tree-stats */
  OPT_trigraphs = 2016,                      /* -trigraphs */
  OPT_type_stats = 2017,                     /* -type-stats */
  OPT_u = 2018,                              /* -u */
  OPT_undef = 2019,                          /* -undef */
  OPT_v = 2020,                              /* -v */
  OPT_version = 2021,                        /* -version */
  OPT_w = 2022,                              /* -w */
  OPT_wrapper = 2023,                        /* -wrapper */
  OPT_x = 2024,                              /* -x */
  OPT_z = 2025,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
